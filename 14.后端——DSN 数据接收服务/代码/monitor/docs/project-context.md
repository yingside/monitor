...
> 本文档描述**第 14 章结束后**项目的完整状态，供后续章节开发时快速建立上下文，避免重复探索代码。
...
| 项目 | 说明 |
|---|---|
| **根目录** | `14.后端——DSN 数据接收服务/代码/monitor/` |
| **包管理器** | pnpm 10.x |
| **构建工具** | Turborepo v2 |
| **Node.js** | v25.x |
...
dsn-server (localhost:3000)    ← ✅ 第 14 章已实现，接收上报并写入 Kafka
