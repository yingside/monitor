  ...
  <div class="container">
    ...
    <section class="section">
      ...
      <div class="actions">
        ...
        <button class="btn" @click="sendPerf">模拟性能事件 (performance)</button>
      </div>
    </section>

    <p class="tip">
      ⓘ 控制台预期输出：<br />
      <code>subType: 'js'</code> — JS 运行时错误<br />
      <code>subType: 'resource'</code> — 资源加载失败<br />
      <code>subType: 'promise'</code> — Promise 未捕获异常<br />
      <code>subType: 'vue'</code> — Vue 框架层错误
    </p>
  </div>
</template>
