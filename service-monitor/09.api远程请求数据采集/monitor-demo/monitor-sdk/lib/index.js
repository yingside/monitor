var monitor = function () {
  ...
  var originalPrototype = XMLHttpRequest.prototype;
  var originalOpen = originalPrototype.open;
  var originalSend = originalPrototype.send;
  function overWriteOpenAndSend() {
    originalPrototype.open = function newOpen() {
    ...
    originalPrototype.send = function newSend() {
      var _this = this;
